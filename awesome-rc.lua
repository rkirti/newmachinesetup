...
globalkeys = awful.util.table.join(
    ...
    -- Use WASD keys for resizing active window (up, down, left, right)
    ...
    awful.key({ modkey, "Control" }, "w",     function () awful.client.incwfact(0.05)    end),
    awful.key({ modkey, "Control" }, "s",     function () awful.client.incwfact(-0.05)   end),
